...
const selectors = {
  ...
  mainPage_grades_header: '#right_col > div:nth-child(4) > table > tbody > tr:nth-child(1) > td > form > table > tbody > tr:nth-child(3) > td > table > tbody > tr:nth-child(1)',
  mainPage_requests_actions: '#right_col > div:nth-child(4) > table > tbody > tr:nth-child(2) > td > table > tbody > tr > td > div:nth-child(2)',
...
function mainPage() {
  ...
  try {
    if(window.top.document.querySelector(selectors.mainPage_grades_header)) {
      ...
      const grdButton = document.createElement("td");
      grdButton.setAttribute("colspan", "2");
      grdButton.setAttribute("style", "border: 0px;");
      grdButton.setAttribute("nowrap", "");
      grdButton.setAttribute("bgcolor", "#ffffff");
      grdButton.setAttribute("align", "left");
      grdButton.append(parser.parseFromString(`<div class="message_actions">
      <a class="niceButton" id="selectAllGrades">בטל סימון להכל</a>
      </div>`, "text/html").body.firstChild);
      window.top.document.querySelector(selectors.mainPage_grades_header).append(grdButton);
  ...
  try {
    ...
    const requests =   window.top.document.querySelector(selectors.mainPage_requests_actions)
    if (requests) {
